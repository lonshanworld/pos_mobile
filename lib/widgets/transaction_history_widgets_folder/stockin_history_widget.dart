            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final List<UniqueItemModel> combineUniqueItemList = [
                  ...activeUniqueItemList,
                  ...filteredInActiveUniqueItemList,
                ];
                ...
                for (final unique in selectedUniqueItemList) {
                  itemCounts[unique.itemId] =
                      (itemCounts[unique.itemId] ?? 0) + 1;
                }

                final List<String> itemNames = [];
                for (final itemId in itemCounts.keys) {
                ...
                final int totalItems = selectedUniqueItemList.length;
