  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> keyValueList() {
      ...
      final rows = <Widget>[
        ...
        doubleRowStrings(
          'Created by',
          createdPersonModel?.userName ?? 'Unknown',
        ),
        doubleRowStrings(
          'Create time',
          TextFormatters.getDateTime(uniqueItemModel.createTime),
        ),
        doubleRowStrings(
          'Last update',
          uniqueItemModel.lastUpdateTime == null
              ? '--'
              : TextFormatters.getDateTime(uniqueItemModel.lastUpdateTime),
        ),
      ];
      ...
      rows.addAll([
        ...
        doubleRowStrings(
          'Status',
          uniqueItemModel.activeStatus ? 'In stock' : 'Sold / inactive',
        ),
      ]);
      return rows;
    }
