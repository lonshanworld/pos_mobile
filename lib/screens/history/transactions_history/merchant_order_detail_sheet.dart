...
class MerchantOrderDetailSheet extends StatelessWidget {
  ...
  const MerchantOrderDetailSheet({super.key, required this.stockOutModel});
  ...
  Widget build(BuildContext context) {
    ...
    final List<StockOutItemModel> selectedStockOutItemList = context
        ...
        .getSelectedStockOutItemList(stockOutModel.id);

    final List<UniqueItemModel> soldUnits = itemCubit
        .getSelectedUniqueItemFromStockOutId(stockOutModel.id);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  dataRow(
                    'Total Sold Value (Items)',
                    '$totalItemFinalSellPrices MMK',
                  ),
                  if (orderTax > 0) dataRow('Checkout Tax', '$orderTax MMK'),
            ...
            if (showUnitBreakdown && soldUnits.isNotEmpty) ...[
              ...soldUnits.map((unit) {
                final ItemModel? singleItem = allItemList.firstWhereOrNull(
                  (e) => e.id == unit.itemId,
                );
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      dataRow(
                        'Unit sell',
                        '${unitSell.toStringAsFixed(0)} MMK',
                      ),
